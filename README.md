...
## Verifcation for rest api

- follow above steps to run crawler and converter, make sure solr have data
- run `./gradlew clean test jacocoTestReport` to check unit test
- run `./gradlew bootRun -Pargs=--rest` to run rest api
- open postman, import api and env from *docs* folder, then check the api
